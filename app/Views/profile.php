...
<nav class="navbar">
        <div><img src="<?= base_url("assets/img/11.jpg")?>" alt="" style = "width: 50px; border-radius: 50%";> Nicholas Elvis</div>
        <ul class="nav-links">
    ...
    <center>
        ...
        <div class="bglist">
            <br>
            <img src="<?= $user['foto']?? base_url('/assets/img/11.jpg')?>" alt="..." style = "width : 200px; border-radius: 50%;"><br><br>
